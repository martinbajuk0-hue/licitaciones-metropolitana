# Informe de licitación: Compra Directa 1016/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1371496
**Generado:** 2026-09-14 16:18
**Qué es:** Licitación de BSE - Banco de Seguros del Estado — busca Material mencionado (revisar contexto), Terminología genérica del pliego (revisar manualmente qué producto aplica). Menciona "recubrimiento": «oluciones parenterales Estructura | Estructura metálica con recubrimiento epóxico anticorrosivo, de fácil limpieza y desinfección Bal»
...
- **Terminología genérica del pliego (revisar manualmente qué producto aplica)** ("recubrimiento"): ...oluciones parenterales Estructura | Estructura metálica con recubrimiento epóxico anticorrosivo, de fácil limpieza y desinfección Bal...
- **Material mencionado (revisar contexto)** ("acrílico"): ...contención | Barandas laterales abatibles/transparentes en acrílico para seguridad del neonato Panel de control | Panel frontal...
- **Material mencionado (revisar contexto)** ("cuarzo"): ...entamiento | Calor radiante mediante elemento calefactor de cuarzo o halógeno de alta eficiencia Modos de control de temperatu...
...
- Lugar de uso mencionado: almacen, fabrica, hospital, hospital regional, ministerio
- Aplicación mencionada: certificado, de fácil limpieza, impermeable, lavable, térmico
...
- Fichas técnicas de los productos ofertados — evidencia: «or cada fabricante. Se recomienda solicitar al proveedor la ficha técnica oficial, certificados de conformidad y registro sanitario c»
