# Informe de licitación: Compra Directa 146/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1358420
...
- **Pisos de madera** ("parquet"): ...ENTO | OBSERVACIONES (2) | ES ASCENSOR CHICO, CON REJA PISO PARQUET ENCERADO (2) En la medida de las posibilidades manifestar m...
- **Pisos de madera** ("piso parquet"): ...ARTAMENTO | OBSERVACIONES (2) | ES ASCENSOR CHICO, CON REJA PISO PARQUET ENCERADO (2) En la medida de las posibilidades manifestar m...
- **Material mencionado (revisar contexto)** ("ceramica"): ..., cocina y otros | 7 COMPLETAR EN CASO DE SER APTO | PISO | CERAMICA COMPLETAR EN CASO DE SER APTO | ASCENSOR | NO COMPLETAR EN...
...
- Lugar de uso mencionado: comedor, correo, parque, plaza
