# Informe de licitación: Compra Directa 153/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1353128
...
- +25 por código de artículo ARCE ya adjudicado a Metropolitana antes (match exacto, no por texto): REPARACION DE PISO
...
- **Pisos de madera** ("parqué"): ..., convoca a Compra Directa para “restauración de un piso de parqué” de División Seguridad en el Transito, sita en Rincón 575,...
- **Material mencionado (revisar contexto)** ("madera"): ...ción de las tareas a realizar: Recolocación de tablillas de madera que fueron retiradas y acopiadas en el lugar (aprox.10 m2),...

### Ya adjudicaste antes
Metropolitana ya le vendió al Estado alguno de estos productos antes (historial 2025-2026, ver knowledge/historial_adjudicaciones_metropolitana.json): REPARACION DE PISO, ZOCALO DE MADERA, PANEL DE MADERA, REPARACION DE PISO DE MADERA.
### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: correo, dirección, ministerio, mtop
