# Informe de licitación: Compra Directa 228/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1329586
...
- Plazo/fecha de entrega: 30 días hábiles (plazo relativo — no es una fecha fija, calcular desde la orden de compra/notificación)
...
- **Terminología genérica del pliego (revisar manualmente qué producto aplica)** ("mantenimiento edilicio"): ...Sanidad de las FF.AA., previa coordinación con el  Dpto. de Mantenimiento Edilicio - D.A.I.H.FF.AA.  LUGAR DE ENTREGA  FACTURACIÓN:  Dirección...
- **Material mencionado (revisar contexto)** ("madera"): ...(hidrojet) + succión/vacuum, retirando:  trapos, botellas, maderas, escombros, arenas, sedimentos y todo material que impida...
...
- Lugar de uso mencionado: banco, correo, direccion, dirección, estación de servicio, facultad, facultades, hospital, instituto, intendencia, intendencia de montevideo, mi, patio, plaza
...
- [MEDIA] certificaciones: Norma UNIT exigida — «ológico  Nacional – actualización por Decreto 375/011).    Norma UNIT: 833 2008   Registro/habilitación para empresas de limpiez»
...
- Formulario de identificación del oferente — evidencia: «.AA.  REQUISITOS    OBLIGATORIOS:  ANEXO II (formulario de  identificación del oferente)  Firmado por persona acreditada en  R.U.P.E. con facultade»
