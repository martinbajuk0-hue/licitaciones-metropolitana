...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1357426
...
## Datos clave
- Organismo: Intendencia de Cerro Largo
- Número de licitación/expediente: 53/2026
...
- **Material mencionado (revisar contexto)** ("madera"): ...ca. Deberá entregarse en bolsas de plastillera o cajones de madera o plástico retornable o descartable.      CEBOLLA DE VERDEO...
- **Material mencionado (revisar contexto)** ("nylon"): ...hojas marchitas odecoloradas. Deberá entregarse en bolsa de nylon.     APIO Aspecto y color: Atados frescos de hojas, de colo...
...
- Lugar de uso mencionado: almacen, banco, correo, depósito, direccion, dirección, fabrica, facultad, facultades, instituto, intendencia, intendencia de cerro largo, mgap, ministerio, oficina
- Aplicación mencionada: certificado, térmico

## Riesgos detectados
Altos: 2 · Medios: 0 · Total: 2

- [ALTA] multas_penalidades: Mora automática — «diciones del vehículo utilizado para la distribución.   22) Mora automática, Incumplimientos y Sanciones  El adjudicatario incurrirá en»
- [ALTA] multas_penalidades: Mora automática — «Incumplimientos y Sanciones  El adjudicatario incurrirá en mora de pleno derecho sin necesidad de interpelación judicial o extrajudicial alg»

## Checklist documental
### Exigidos explícitamente en el pliego
- Inscripción activa en RUPE — evidencia: «acreditada en el Registro Único de Proveedores del Estado (RUPE).   Comunicaciones   INAU realizará todas las comunicacione»
- Poderes / representación legal vigentes — evidencia: «D) Anexo III “Cuadro de Cotización” firmado por titular o representante legal de la empresa acreditado en el RUPE con facultades suficien»
- Certificado notarial de vigencia / representación — evidencia: «rácter de confidencial.  En caso de que no surja de RUPE el certificado notarial validado que acredite la constitución de la empresa, vigenc»
- Garantía de mantenimiento de oferta — evidencia: «os en el artículo 13 de la mencionada Ley.  	   	13)Plazo y garantía de mantenimiento de oferta   13.1Plazo de mantenimiento de oferta. Comunicaciones de d»
- Garantía de fiel cumplimiento de contrato — evidencia: «viada), documento acreditante de que se realizó depósito de garantía de fiel cumplimiento del contrato.  El adjudicatario deberá, en tal caso, consti»
- Pólizas de seguro (responsabilidad civil / accidentes) — evidencia: «o trámite alguno o discusión para hacer efectivo su cobro.  Póliza de seguro de fianza emitida por Compañía de Seguros que cue»
- Declaraciones juradas exigidas — evidencia: «más de lo solicitado en la cláusula 10 del presente Pliego, declaración jurada detallando los  bienes y servicios que califican como nacio»
- Formulario de identificación del oferente — evidencia: «sentar al momento de la Apertura de Ofertas:  Formulario de Identificación del Oferente en formato no editable (ANEXO I). El formulario de identifi»
