# Informe de licitación: Compra Directa 283/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1370534
**Generado:** 2026-09-10 18:11
**Qué es:** Licitación de organismo no identificado — busca Material mencionado (revisar contexto). Menciona "acero inoxidable": «DIRECTA Nº283/2026 TÍCULO Material USTRIAL GRANDE ACERO INOXIDABLE VIDOR A INDUSTRIAL IPO PIRAMIDE STRIAL MEDIANO CNICA:»
...
- **Material mencionado (revisar contexto)** ("acero inoxidable"): ...DIRECTA Nº283/2026  TÍCULO Material  USTRIAL GRANDE         ACERO INOXIDABLE  VIDOR  A INDUSTRIAL  IPO PIRAMIDE  STRIAL MEDIANO  CNICA:...
- **Material mencionado (revisar contexto)** ("madera"): ...ompra:   ÍTEM ARTÍCUL  1 CUCHARON INDUSTR  2 HERVIDO  3 ESPUMADERA IN  4 RALLADOR TIPO  5 CUCHARON INDUSTR    REQUERIMIENTOS:...
...
- Lugar de uso mencionado: bomberos, cuartel, fabrica, mi
- Aplicación mencionada: interior

## Riesgos detectados
Altos: 0 · Medios: 1 · Total: 1

- [MEDIA] plazos: Plazo de 72 horas mencionado — «izará en pesos uruguayos.   Crédito SIIF  GA: De Inmediata (72 horas) a 10 días hábiles.  EGA: Cuartel Centenario de Bomberos Co»

## Checklist documental
### Exigidos explícitamente en el pliego
- Inscripción activa en RUPE — evidencia: «eros-compras@mi  ferencia)    eedor debe estar inscripto en RUPE y encontrar  yente). Los datos de la empresa y domicilio el»
- Catálogos de producto — evidencia: «nicas del producto ofertado, pudiendo aco  to informativo o catalogo.  NÓMICA: Se tendrá por propuesta económica l  precio se co»
