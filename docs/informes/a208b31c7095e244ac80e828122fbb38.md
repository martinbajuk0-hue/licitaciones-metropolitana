...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1360967
...
## Datos clave
- Organismo: UTE - Administración Nacional de Usinas y Trasmisiones Eléctricas
- Número de licitación/expediente: 13-26
...
- Fecha límite de consultas: 2026-08-13
...
- **Terminología genérica del pliego (revisar manualmente qué producto aplica)** ("materiales de construcción"): ...zona de la obra para investigar la   disponibilidad de los materiales de construcción, mano de obra, transporte y de manera especial las   fuente...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: banco, bps, carcel, comedor, comedores, correo, depósito, depósitos, direccion, dirección, facultad, instituto, ministerio, mtop, oficina
...
- [MEDIA] plazos: Plazo de 48 horas mencionado — «, D, F, o G la UdelaR le   otorgará al proveedor entre 24 o 48 horas para su presentación, según la urgencia del   procedimiento»

## Checklist documental
### Exigidos explícitamente en el pliego
- Inscripción activa en RUPE — evidencia: «de  la web de ARCE). Obligatorio en caso de no estar en el  RUPE actualizado Formulario F: Experiencia en obras similares Fo»
- Certificado único de BPS vigente — evidencia: «tas propuestos con indicación de su forma de aportación al  BPS (si aporta o no por Ley Nº 14.411). Formulario E: Inscripci»
- Poderes / representación legal vigentes — evidencia: «s en la  Ley 18.516/09  y decreto 255/010, firmada por el   representante legal correspondiente.-  Documentación que acredite el cumplimie»
...
- Pólizas de seguro (responsabilidad civil / accidentes) — evidencia: «bancario o en valores públicos, fianza o aval   bancario o póliza de seguro de fianza.  La garantía de fiel cumplimiento de c»
- Declaraciones juradas exigidas — evidencia: «caso de no poder obtenerla, el oferente   deberá presentar Declaración Jurada  en la que conste no tener incumplimientos de  las   condic»
...
- 2026-08-13: Enviar consultas/aclaraciones si corresponde
