# Informe de licitación: Compra Directa 268/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1368913
**Generado:** 2026-09-03 23:18
**Qué es:** Licitación de Ministerio de Desarrollo Social (MIDES) — busca Material mencionado (revisar contexto). Menciona "algodón": «alle: Ítem Descripción Cantidades HASTA 1 Camisón en algodón Colores lisos claros en tonos de blanco, beige, gris claro»
...
- **Material mencionado (revisar contexto)** ("algodón"): ...alle:     Ítem Descripción Cantidades  HASTA   1 Camisón en algodón  Colores lisos claros en tonos de blanco, beige, gris claro...
- **Material mencionado (revisar contexto)** ("nylon"): ...le XL/XXL  500  Forma de entrega:  Cada camisón en bolsa de nylon marcado con el talle    Modo de entrega: deben entregarse e...
