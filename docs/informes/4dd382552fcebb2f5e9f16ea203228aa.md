# Informe de licitación: Compra Directa 260/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1369863
**Generado:** 2026-09-07 23:18
**Qué es:** Licitación de organismo no identificado — busca Material mencionado (revisar contexto). Menciona "algodón": «ÍTEM ARTÍCULO CANTIDAD HASTA 1 REMERAS MANGA LARGA- 100 % ALGODÓN COLOR AZUL 2095 REQUISITOS TÉCNICOS: ÍTEM 1: REMERAS MA»
...
- **Material mencionado (revisar contexto)** ("algodón"): ...ÍTEM ARTÍCULO CANTIDAD  HASTA  1 REMERAS MANGA LARGA- 100 % ALGODÓN COLOR AZUL 2095    REQUISITOS TÉCNICOS:  ÍTEM 1: REMERAS MA...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: bomberos, cuartel, fabrica, ma
...
- Inscripción activa en RUPE — evidencia: «enda.      IMPORTANTE: El proveedor debe estar inscripto en RUPE y encontrarse en  estado Activo (Requisito excluyente). Los»
- Catálogos de producto — evidencia: «diendo acompañar fotos  ilustrativas, folleto informativo o catálogo.  ● PROPUESTA ECONÓMICA: Se tendrá por propuesta económica»
