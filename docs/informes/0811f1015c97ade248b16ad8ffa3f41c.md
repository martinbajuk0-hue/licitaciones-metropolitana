# Informe de licitación: Compra Directa 10203/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1368191
**Generado:** 2026-09-02 18:51
**Qué es:** Licitación de Ministerio de Educación y Cultura — busca Material mencionado (revisar contexto), Pisos vinílicos. Menciona "vinilo": «as 1 1 Código 12234 Impresión de lona para Roll Up Lona vinilo, tamaño 80 x 200 cm, impresión full color. Diseño proporci»
...
- **Pisos vinílicos** ("vinilo"): ...as  1 1 Código  12234 Impresión de lona para Roll Up   Lona vinilo, tamaño 80 x 200 cm, impresión full color. Diseño  proporci...
- **Material mencionado (revisar contexto)** ("aluminio"): ...proporcionado por el cliente. Incluye base portabanner de  aluminio y estuche de transporte.  3 500 Código 3714 Stickers autoad...
- **Material mencionado (revisar contexto)** ("vinilo"): ...as  1 1 Código  12234 Impresión de lona para Roll Up   Lona vinilo, tamaño 80 x 200 cm, impresión full color. Diseño  proporci...
...
- Lugar de uso mencionado: mec, oficina
