# Informe de licitación: Licitación Abreviada 152091/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1363087
...
- **Normativa/certificación mencionada** ("en iso"): ...13    1- Precio por kilogramo de producto en isomódulos   2- Precio por alquiler del isomódulo   Se deberá i...
- **Normativa/certificación mencionada** ("msds"): ...nejo y toxicólogas que  correspondan del producto ofertado (MSDS). Cuando sea procedente, el oferente informará el  contenid...
- **Abreviatura técnica del rubro** ("msds"): ...nejo y toxicólogas que  correspondan del producto ofertado (MSDS). Cuando sea procedente, el oferente informará el  contenid...
...
- Lugar de uso mencionado: aduana, aeropuerto, ancap, banco, bancos, brou, correo, depósito, depósitos, dirección, estación de servicio, fabrica, facultad, facultades, oficina
...
- Inscripción activa en RUPE — evidencia: «..... 18  IV.3 - REGISTRO ÚNICO DE PROVEEDORES DEL ESTADO – RUPE ........................................... 18  IV.4 - DEBE»
- Catálogos de producto — evidencia: «rse con la sección Catál ogo de ARCE al correo electrónico  catalogo@acce.gub.uy para solicitar la inclusión y/o asesorarse acer»
- Pólizas de seguro (responsabilidad civil / accidentes) — evidencia: «12    constituidas bajo fianzas, avales bancarios o pólizas de seguro de fianzas que no sean de cobro  efectivo a prim»
- Antecedentes en obras/suministros similares — evidencia: «.2 - ANTECEDENTES   Se deberá presentar junto con la oferta antecedentes de suministros similares al licitado,  debiendo indicar cliente, teléfono,»
