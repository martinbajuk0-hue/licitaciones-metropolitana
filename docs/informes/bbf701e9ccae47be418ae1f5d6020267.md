# Informe de licitación: Compra Directa 13813/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1363736
...
- **Terminología genérica del pliego (revisar manualmente qué producto aplica)** ("recubrimiento"): ...ligeramente acolchado con material amorfo, cubierto por un  recubrimiento ULF (Ultra Low Friction).  1  Foto  4 Pegamento tisular de...
- **Material mencionado (revisar contexto)** ("polietileno"): ...3  Transfer  hospitalario ADULTO (Consiste en un tablero de polietileno  rígido muy delgado, (aproximadamente 1,5 cm ) no deformabl...
...
- Lugar de uso mencionado: asse, correo, dirección, hospital, mi, oficina, tribunal
...
- Catálogos de producto — evidencia: «ra disponible en elsistema,deberácomun icarsecon  lasección Catálogo de ARCE al correo  electrónicocatalogo@arce.gub.uy para sol»
- Declaraciones juradas exigidas — evidencia: «rte de  la unidad ejecutora.  4) El Proveedor deberá enviar DECLARACIÓN JURADA POR EL  ARTICULO 46 con TIMBRE PROFESIONAL $ 270.  5) Prese»
