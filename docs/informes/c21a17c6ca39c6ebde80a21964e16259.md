# Informe de licitación: Compra Directa 371/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1361119
...
Categorías de producto detectadas: Accesorios de instalación.
...
Categorías detectadas: Accesorios de instalación

- **Accesorios de instalación** ("esquinero"): ...gitud total (incluyendo el codo). Los postes de refuerzo y  esquineros serán de 0,10 x 0,10 x 3,30 m. Se colocará un poste de ref...
- **Accesorios de instalación** ("esquineros"): ...gitud total (incluyendo el codo). Los postes de refuerzo y  esquineros serán de 0,10 x 0,10 x 3,30 m. Se colocará un poste de refu...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: aeropuerto, aeropuertos, almacen, bps, correo, direccion, dirección, fabrica, oficina, puerto
...
- Certificado único de BPS vigente — evidencia: «l Art. 83 del Decreto 220/998 d el 12/08/98. Los aportes al BPS podrán ser  realizados por el régimen de Industria y Comerc»
