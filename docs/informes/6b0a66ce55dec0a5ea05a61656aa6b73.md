...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1370397
**Generado:** 2026-09-09 14:14
**Qué es:** Licitación de organismo no identificado — busca Alfombras, Variante/error ortográfico de un término del rubro. Menciona "carpet": «ecuperación de pavimentos de hormigón mediante recapado con carpeta asfáltica en caliente y la reconstrucción de la estructura»
...
## Datos clave
- Organismo: **NO IDENTIFICADO — verificar manualmente**
- Número de licitación/expediente: 15/2026
...
- **Alfombras** ("carpet"): ...ecuperación de pavimentos de hormigón mediante recapado con carpeta asfáltica en caliente y la reconstrucción de la estructura...
- **Variante/error ortográfico de un término del rubro** ("carpeta"): ...ecuperación de pavimentos de hormigón mediante recapado con carpeta asfáltica en caliente y la reconstrucción de la estructura...
