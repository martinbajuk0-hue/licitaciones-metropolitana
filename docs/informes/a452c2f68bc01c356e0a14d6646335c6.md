# Informe de licitación: Licitación Abreviada 109486/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1370750
...
- Lugar de uso mencionado: antel, banco, bancos, bps, brou, bse, correo, depósito, direccion, dirección, estación de servicio, fabrica, facultad, facultades, ministerio
- Aplicación mencionada: certificado, exterior, homologado

## Riesgos detectados
Altos: 0 · Medios: 1 · Total: 1

- [MEDIA] plazos: Plazo de 48 horas mencionado — «ico de investigación correspondiente, en un plazo máximo de 48 horas.   10) En caso de emplear subcontratistas exigiremos fehaci»

## Checklist documental
### Exigidos explícitamente en el pliego
- Inscripción activa en RUPE — evidencia: «ra poder contratar con Antel, deberá estar ins cripto en el RUPE (Registro Único de  Proveedores del Estado) en Estado de pr»
