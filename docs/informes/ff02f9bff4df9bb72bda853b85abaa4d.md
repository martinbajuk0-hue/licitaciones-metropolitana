# Informe de licitación: Licitación Abreviada 66/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1372961
**Generado:** 2026-09-17 23:24
**Qué es:** Licitación de Intendencia de Paysandú — busca Alfombras, Variante/error ortográfico de un término del rubro, apertura 2026-10-01. Menciona "carpet": «litación para explotación de cantera. b) AGREGADO FINO PARA CARPETA ASFÁLTICA – Deberá cumplir con las condiciones del PLIE»
...
- Fecha de apertura: 2026-10-01 (Cierra en 14 días)
...
- **Alfombras** ("carpet"): ...litación para explotación de cantera. b) AGREGADO FINO PARA CARPETA ASFÁLTICA – Deberá cumplir con las condiciones    del PLIE...
- **Variante/error ortográfico de un término del rubro** ("carpeta"): ...litación para explotación de cantera. b) AGREGADO FINO PARA CARPETA ASFÁLTICA – Deberá cumplir con las condiciones    del PLIEG...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: correo, depósito, direccion, dirección, intendencia, intendencia de paysandu, intendencia de paysandú, miem, ministerio, mtop, oficina, recepción, tribunal
...
- [ALTA] multas_penalidades: Riesgo de rescisión contractual — «to de lo establecido en la presente cláusula será causal de rescisión del  contrato. El director de la obra, siempre que sea con 48horas de ant»
- [MEDIA] plazos: Plazo de 48 horas mencionado — «del  contrato. El director de la obra, siempre que sea con 48horas de antelación, se reserva el derecho  de pedir menos, o det»
...
- Declaraciones juradas exigidas — evidencia: «adjudicada la compra. El adjudicatario deberá presentar una declaración jurada en la que se comprometa a una  capacidad mínima de entrega»
- Formulario de identificación del oferente — evidencia: «n de Vialidad INTENDENCIA DE PAYSANDU ANEXO 1 FORMULARIO DE IDENTIFICACIÓN DEL OFERENTE Licitación Publica Nro. 66 Razón Social de la Empresa:.....»
...
- 2026-10-01: Entrega de oferta (fecha de apertura)
