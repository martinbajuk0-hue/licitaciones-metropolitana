# Informe de licitación: Compra Directa 3349/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1371445
**Generado:** 2026-09-14 16:19
**Qué es:** Licitación de ASSE - Administración de los Servicios de Salud del Estado — busca Material mencionado (revisar contexto). Menciona "espuma de poliuretano": «ientes insumos: Ítem N°1: 10 colchonetas. Características: espuma de poliuretano, densidad media con forro tela impermeable lisa color blan»
...
- **Material mencionado (revisar contexto)** ("espuma de poliuretano"): ...ientes insumos: Ítem N°1: 10 colchonetas.  Características: espuma de poliuretano, densidad media con forro tela impermeable lisa  color blan...
- **Material mencionado (revisar contexto)** ("poliuretano"): ...umos: Ítem N°1: 10 colchonetas.  Características: espuma de poliuretano, densidad media con forro tela impermeable lisa  color blan...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: asse, correo, dirección, oficina, plaza
- Aplicación mencionada: impermeable, lavable
