# Informe de licitación: Compra Directa 199/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1363746
...
- **Material mencionado (revisar contexto)** ("acero inoxidable"): ...ONTRATANTE: D.N.S.P. OBJETO DEL LLAMADO: COMPRA DE CARRO DE ACERO INOXIDABLE Y CARRO ISO- TÉRMICO PARA TRASLADO DE ALIMENTOS. TIPO Y NUM...
- **Material mencionado (revisar contexto)** ("policarbonato"): ...IONES CARRO ISOTÉRMICO PARA TRASLADO DE ALIMENTOS  MATERIAL POLICARBONATO 2 PUERTAS 2 RUEDAS FIJAS, 2 GIRATORIAS, 1 CON FRENO. PARA D...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: depósito, dirección, facultad, instituto, plaza, recepción
- Aplicación mencionada: certificado, termico, térmico
...
- Declaraciones juradas exigidas — evidencia: «Al mismo tiempo, el certificado de la DNI deberá incluir la declaración jurada del oferente donde se indique que su producto (bien, servic»
