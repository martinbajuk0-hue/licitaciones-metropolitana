...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1373883
**Generado:** 2026-09-22 18:56
**Qué es:** Licitación de organismo no identificado — busca Terminología genérica del pliego (revisar manualmente qué producto aplica). Menciona "puesta en valor": «Licitación Abreviada 37/2026 Acondicionamiento y puesta en valor Rambla de Los Constituyentes-Carmelo»
...
- **Terminología genérica del pliego (revisar manualmente qué producto aplica)** ("puesta en valor"): ...Licitación Abreviada 37/2026 Acondicionamiento y puesta en valor Rambla de Los Constituyentes-Carmelo...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: rambla
