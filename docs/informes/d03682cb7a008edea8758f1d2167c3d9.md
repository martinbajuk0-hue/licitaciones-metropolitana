...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1358617
**Generado:** 2026-08-25 00:50
**Qué es:** Licitación de Intendencia de Soriano — categorías de producto detectadas: Marca de mercado mencionada, Variante/error ortográfico de un término del rubro.
...
Organismo: Intendencia de Soriano.
...
- **Marca de mercado mencionada** ("roca"): ...cinco (5) ciclos de ensayo. Además, en el   caso de emplear roca basáltica para preparación de los agregados, las  fracturas...
- **Variante/error ortográfico de un término del rubro** ("recubierta"): ...dos por partículas duras, rugosas y  estables, que no estén recubiertas parcial o totalmente, por sustancias  que impidan su perfe...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: correo, depósito, dirección, intendencia, intendencia de soriano, ministerio, oficina, recepción

## Riesgos detectados
Altos: 0 · Medios: 1 · Total: 1

- [MEDIA] certificaciones: Norma UNIT exigida — «sentar resultados de ensayos de:  1) Tamizado de agregados, Norma Unit 48; 2) Determinación de polvo   impalpable en agregados, No»

## Checklist documental
### Exigidos explícitamente en el pliego
- Garantía de fiel cumplimiento de contrato — evidencia: «á  solicitar la totalidad del material a adquirir.  Art.12) GARANTÍA DE FIEL CUMPLIMIENTO DE CONTRATO.  En caso de alcanzar y/o superar el monto esta»
