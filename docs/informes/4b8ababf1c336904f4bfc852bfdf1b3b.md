# Informe de licitación: Compra Directa 126/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1370083
**Generado:** 2026-09-10 18:09
**Qué es:** Licitación de OSE - Obras Sanitarias del Estado — busca Material mencionado (revisar contexto). Menciona "algodón": «de manga larga con bolsillo en el frente, de gabardina de algodón o técnica transpirable con protección UV. Cantidad: hast»
...
- **Material mencionado (revisar contexto)** ("algodón"): ...de manga larga con bolsillo en el  frente, de gabardina de algodón o técnica transpirable con  protección UV.   Cantidad: hast...
- **Material mencionado (revisar contexto)** ("goma"): ...oliva o gris     ÍTEM 3.- Zapatilla acuática, con suela de goma antideslizante,  apto para uso en arena para dama y caballe...
...
- Lugar de uso mencionado: correo, ma, parque, parques, recepción
- Aplicación mencionada: antideslizante, exterior, impermeable
...
- Inscripción activa en RUPE — evidencia: «registrado en el Registro  Único de Proveedores del Estado (RUPE), conforme a lo dispuesto por el Decreto del Poder  Ejecuti»
- Declaraciones juradas exigidas — evidencia: «MPRESA      NOMBRE COMERCIAL DE LA EMPRESA      R.U.T.      DECLARACIÓN JURADA  El que suscribe declara contar con capacidad para contrata»
- Formulario de identificación del oferente — evidencia: «e considere conveniente.    Documentación   • Formulario de identificación del oferente, que luce como Anexo I.    Adjudicación   • La adjudicación»
