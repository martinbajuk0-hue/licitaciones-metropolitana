# Informe de licitación: Compra Directa 83/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1366321
**Generado:** 2026-09-21 16:35
**Qué es:** Licitación de OSE - Obras Sanitarias del Estado — busca Material mencionado (revisar contexto). Menciona "acero inoxidable": «atos de la puerta: pivotante, batiente, de chapa plegada de acero inoxidable. 1.2.2. Reparación de puerta de hall de acceso de públic»
...
- **Material mencionado (revisar contexto)** ("acero inoxidable"): ...atos de la puerta: pivotante, batiente, de chapa plegada de acero inoxidable.    1.2.2. Reparación de puerta de hall de acceso de públic...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: correo, dirección, facultad, facultades, plaza, recepción
- Aplicación mencionada: interior

## Riesgos detectados
Altos: 2 · Medios: 0 · Total: 2

- [ALTA] multas_penalidades: Mora automática — «1 31      17. MORA Y PENALIDADES  El adjudicatario caerá en mora de pleno derecho y sin necesidad de protesto, ni d e  interpelación judicial»
- [ALTA] multas_penalidades: Penalidades mencionadas — «ISTROS  SORIANO 802 PISO 5- TEL. 2901 51 31      17. MORA Y PENALIDADES  El adjudicatario caerá en mora de pleno derecho y sin nece»

## Checklist documental
### Exigidos explícitamente en el pliego
- Inscripción activa en RUPE — evidencia: «través de correo electrónico indicado por el proveedor o en RUPE.    5. COTIZACION DE LA PROPUESTA  Se deberá cotizar exclus»
...
- Constancia de visita de obra (si el pliego la exige) — evidencia: «s y complementarias.     3.  VISITAS     No obligatoria. La visita previa cotización de los t rabajos solicitados no es obligatoria,»
- Formulario de identificación del oferente — evidencia: «nte documentación, debidamente  firmada:     Formulario de identificación del oferente. (Anexo I)   Formulario de Antecedentes : Se acreditarán a»
