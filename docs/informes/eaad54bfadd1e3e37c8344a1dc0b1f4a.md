...
- **Material mencionado (revisar contexto)** ("acero inoxidable"): ...SICIONES N° ÍTEM: 7 DESCRIPCIÓN DEL ÍTEM: TORNILLO ALLEN DE ACERO INOXIDABLE CABE- ZA CILINDRICA MILIMETRICA 6 X 20 MM CANTIDAD SOLICITA...
- **Material mencionado (revisar contexto)** ("aglomerado"): ...DURA PARA PLACARD N° ÍTEM: 3 DESCRIPCIÓN DEL ÍTEM: CHAPA DE AGLOMERADO MELAMINICO 2.60 X  1.83 X 18 M X M X MM CANTIDAD SOLICITADA...
- **Material mencionado (revisar contexto)** ("aluminio"): ...IFICACIONES • TIRADOR METÁLICO PARA MUEBLE TIPO BOTON COLOR ALUMINIO José Batlle y Ordóñez 3574                     Tel. 2030 10...
...
- Inscripción activa en RUPE — evidencia: «metido al total cumplimiento de   éstos. INSCRIPCIÓN EN  EL RUPE El oferente deberá estar registrado en el Registro Único de»
