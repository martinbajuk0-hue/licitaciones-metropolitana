# Informe de licitación: Compra Directa 20151/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1375085
**Generado:** 2026-09-25 23:56
**Qué es:** Licitación de Ministerio de Educación y Cultura (MEC) — busca Material mencionado (revisar contexto), Terminología genérica del pliego (revisar manualmente qué producto aplica). Menciona "memoria constructiva": «1, Brazo Oriental, Montevideo. FECHA: Setiembre 2026. MEMORIA CONSTRUCTIVA Y DESCRIPTIVA PARTICULAR 1. GENERALIDADES 1.1. Aspectos»
...
- **Terminología genérica del pliego (revisar manualmente qué producto aplica)** ("memoria constructiva"): ...1, Brazo  Oriental, Montevideo.  FECHA: Setiembre 2026.     MEMORIA CONSTRUCTIVA Y DESCRIPTIVA PARTICULAR   1. GENERALIDADES   1.1. Aspectos...
- **Material mencionado (revisar contexto)** ("látex"): ...dican en los gráficos adjuntos. La  pintura será de calidad látex exterior sobre imprimación, dándose siempre un mínimo de 2...
- **Material mencionado (revisar contexto)** ("madera"): ...1.2 Limpieza inicial de obra 1 gl 2.1 Retirar aberturas de madera 5 un 3.1 Tapeo de vanos 45 m2 3.2 Revoques 45 m2 4.1 Pintur...

### Ya adjudicaste antes
Metropolitana ya le vendió al Estado alguno de estos productos antes (historial 2025-2026, ver knowledge/historial_adjudicaciones_metropolitana.json): ZOCALO DE MADERA, PANEL DE MADERA, GOMA DE LATEX 1.5 ESPESOR 3 MM, REPARACION DE PISO DE MADERA.
### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: aula, comedor, depósito, depósitos, dirección, escuela, galería, mec, ministerio, oficina, oficinas, plaza, recepción, vestuario
