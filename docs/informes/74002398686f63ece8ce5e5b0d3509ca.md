...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1336839
**Generado:** 2026-09-10 14:06
**Qué es:** Licitación de OSE - Obras Sanitarias del Estado — busca Material mencionado (revisar contexto). Menciona "acrilico": «IENTO DE ALUCOBOND CARTEL LUMNOSO: LETRAS CORPOREAS CHAPA Y ACRILICO CARTEL LUMINOSO EN CHAPA Y ACRILICO REVESTIMIENTO GRANITO R»
...
- **Material mencionado (revisar contexto)** ("acrilico"): ...IENTO DE ALUCOBOND CARTEL LUMNOSO: LETRAS CORPOREAS CHAPA Y ACRILICO CARTEL LUMINOSO EN CHAPA Y ACRILICO REVESTIMIENTO GRANITO R...
- **Material mencionado (revisar contexto)** ("granito"): ...da a nivel peatonal, incluyendo  vereda y revestimientos de granito.   3.2.3 PRECAUCIONES. Se tendrá especial cuidado de no dañ...
...
- Lugar de uso mencionado: correo, dirección, facultad, facultades, plaza, recepción, vereda

## Riesgos detectados
Altos: 2 · Medios: 0 · Total: 2

- [ALTA] multas_penalidades: Mora automática — «ganismo.  17. MORA Y PENALIDADES  El adjudicatario caerá en mora de pleno derecho y sin necesidad de prote sto, ni de  interpelación judicial»
- [ALTA] multas_penalidades: Penalidades mencionadas — «los  bienes recibidos por parte del Organismo.  17. MORA Y PENALIDADES  El adjudicatario caerá en mora de pleno derecho y sin nece»

## Checklist documental
### Exigidos explícitamente en el pliego
- Inscripción activa en RUPE — evidencia: «ravés de correo electrónico  indicado por el proveedor o en RUPE.    6. COTIZACION DE LA PROPUESTA  Se deberá cotizar exclus»
...
- Constancia de visita de obra (si el pliego la exige) — evidencia: «es y complementarias.     4.  VISITAS   No obligatoria.  La visita previa cotización de los trabajos solicitados no es obligatoria,»
- Formulario de identificación del oferente — evidencia: «umentación, debidamente firmada:  a) Anexo I- Formulario de identificación del oferente.  b) Anexo II-Formulario de Antecedentes   c) Toda document»
