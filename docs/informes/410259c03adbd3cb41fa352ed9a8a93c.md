# Informe de licitación: Compra Directa 110/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1357364
**Generado:** 2026-08-25 02:05
**Qué es:** Licitación de UTE - Administración Nacional de Usinas y Trasmisiones Eléctricas — categorías de producto detectadas: Abreviatura técnica del rubro, Material mencionado (revisar contexto).
...
- **Material mencionado (revisar contexto)** ("xps"): ...tware  de SCANEO) TIFF  / BMP  /JPG  / PDF  / Secure  PDF / XPS  -  Sistemas  operativos  soportados Win10  o superior  Gar...
- **Abreviatura técnica del rubro** ("esd"): ...mínimo 3–5 km, puertos Gigabit Ethernet, PoE y  protección ESD/EMP.     Ítem 3 – Hasta 8 Teléfonos IP  Teléfonos IP corpor...
- **Abreviatura técnica del rubro** ("xps"): ...tware  de SCANEO) TIFF  / BMP  /JPG  / PDF  / Secure  PDF / XPS  -  Sistemas  operativos  soportados Win10  o superior  Gar...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: almacen, direccion, oficina, puerto
...
- Inscripción activa en RUPE — evidencia: «cto ofrecido.  - La Empresas deberán estar inscriptas en el RUPE y en estado Activo.  - Pago se realizará a través del SIIF.»
