...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1365715
**Generado:** 2026-08-31 11:39
**Qué es:** Licitación de organismo no identificado — categorías de producto detectadas: Accesorios de instalación, Material mencionado (revisar contexto).
...
- **Accesorios de instalación** ("moldura"): ...O I Objeto de compra:   - Ítem 1: Hasta once (11) metros de moldura de polietileno. - Ítem 2: Hasta dos (2) pegamento para mold...
- **Material mencionado (revisar contexto)** ("polietileno"): ...de compra:   - Ítem 1: Hasta once (11) metros de moldura de polietileno. - Ítem 2: Hasta dos (2) pegamento para moldura de polietil...
...
- [MEDIA] plazos: Plazo de 72 horas mencionado — «RMA DE PAGO: Crédito SIIF ● PLAZO DE ENTREGA: De Inmediata (72 horas) a 10 días hábiles. ● LUGAR DE ENTREGA: Cuartel Centenario»

## Checklist documental
### Exigidos explícitamente en el pliego
- Inscripción activa en RUPE — evidencia: «a casilla: IMPORTANTE: El proveedor debe estar inscripto en RUPE y encontrarse en estado Activo  (Requisito excluyente). Los»
- Catálogos de producto — evidencia: «diendo acompañar fotos ilustrativas, folleto informativo o  catálogo.  ● PROPUESTA ECONÓMICA ● COTIZACIÓN: El precio se cotizará»
