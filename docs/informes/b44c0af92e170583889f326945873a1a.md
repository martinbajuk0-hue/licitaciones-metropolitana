# Informe de licitación: Compra Directa 263/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1368668
**Generado:** 2026-09-03 23:21
**Qué es:** Licitación de Ministerio de Desarrollo Social (MIDES) — busca Material mencionado (revisar contexto). Menciona "algodón": «HASTA 1 Conjuntos de pelele y batita Material: 100 % algodón Pelele con pie cerrado. Colores pasteles lisos: blanco,»
...
- **Material mencionado (revisar contexto)** ("algodón"): ...HASTA   1 Conjuntos de pelele y batita    Material: 100 % algodón  Pelele con pie cerrado.   Colores pasteles lisos: blanco,...
- **Material mencionado (revisar contexto)** ("nylon"): ...ses.   1000    Forma de entrega:  Cada conjunto en bolsa de nylon     Modo de entrega: deben entregarse en cajas cerradas deb...
