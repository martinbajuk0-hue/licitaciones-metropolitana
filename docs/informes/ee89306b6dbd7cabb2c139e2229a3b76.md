...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1373903
**Generado:** 2026-09-22 18:54
**Qué es:** Licitación de Ministerio de Vivienda y Ordenamiento Territorial (MVOT) — busca Material mencionado (revisar contexto). Menciona "aluminio": «lica para este llamado PLANILLA MAMPARA DE ALUMINIO Estructura. Perfil tubular de 5x5 Terminac»
...
Organismo: Ministerio de Vivienda y Ordenamiento Territorial (MVOT).
...
- **Material mencionado (revisar contexto)** ("aluminio"): ...lica para este llamado                  PLANILLA MAMPARA DE ALUMINIO  Estructura.                Perfil tubular  de 5x5 Terminac...
- **Material mencionado (revisar contexto)** ("madera"): ...5x5 Cielorraso de yeso desmontable  Estructura de hierro y madera del entrepiso  Vidrio.                      Transparente  6...
...
- Lugar de uso mencionado: brou, ministerio, mvot, oficina, recepción, sala de reuniones
