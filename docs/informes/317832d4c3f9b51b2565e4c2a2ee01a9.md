# Informe de licitación: Compra Directa 182/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1352829
...
- **Material mencionado (revisar contexto)** ("algodón"): ...alogo SICE Descripción SICE Detalle Envase Cantidad 1 29732 ALGODÓN – MANTA – ENVASE – 4 - KG Algodón hidrófilo en manta Bolsa...
- **Material mencionado (revisar contexto)** ("goma"): ...Pág.  2 de 5 11 3268 TUBO DE GOMA SILICONADA  - DIAMETRO – 6 - MM Tubo de silicona, 6 x 9 mm...
...
- Lugar de uso mencionado: bps, correo, facultad, recepción, udelar, universidad
...
- Inscripción activa en RUPE — evidencia: «do por el titular o representante facultado para ello según RUPE (Formulario A). 5.3 - Documentación del adjudicatario a ver»
- Certificado único de DGI vigente — evidencia: «res alimentarios (Art. 3° Ley 18244) • Certificado BPS y de DGI vigentes. Quienes a la fecha indicada no cuenten con dichas»
- Certificado único de BPS vigente — evidencia: «omo deudores alimentarios (Art. 3° Ley 18244) • Certificado BPS y de DGI vigentes. Quienes a la fecha indicada no cuenten c»
- Catálogos de producto — evidencia: «ecta para la compra de material de laboratorio. Ítem Código catalogo SICE Descripción SICE Detalle Envase Cantidad 1 29732 ALGOD»
