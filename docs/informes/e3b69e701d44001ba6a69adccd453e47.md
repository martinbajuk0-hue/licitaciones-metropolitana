# Informe de licitación: Compra Directa 252/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1373391
**Generado:** 2026-09-23 19:14
**Qué es:** Licitación de Ministerio de Transporte y Obras Públicas (MTOP) — busca Material mencionado (revisar contexto), Terminología genérica del pliego (revisar manualmente qué producto aplica). Menciona "recubrimiento": «úblicas, convoca a Compra Directa para “Acondicionamiento y recubrimiento de piso” de taller mecánico de la Regional 1 de la Direcció»

## Clasificación: ★★★ — Dudosa (score 54/100)
...
- +25 por código de artículo ARCE ya adjudicado a Metropolitana antes (match exacto, no por texto): CONSTRUCCION DE PISOS
...
- **Terminología genérica del pliego (revisar manualmente qué producto aplica)** ("recubrimiento"): ...úblicas, convoca a Compra Directa para “Acondicionamiento y recubrimiento de piso” de taller mecánico de la Regional 1 de la Direcció...
- **Material mencionado (revisar contexto)** ("epoxi"): ...el procedimiento previsto. 1.4 – Recubrimiento con pintura epoxi  – Pintura epoxi de alto espesor color gris Suministro y ap...

### Ya adjudicaste antes
Metropolitana ya le vendió al Estado alguno de estos productos antes (historial 2025-2026, ver knowledge/historial_adjudicaciones_metropolitana.json): CONSTRUCCION DE PISOS.
### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: correo, dirección, ministerio, mtop, recepción
...
- Fichas técnicas de los productos ofertados — evidencia: «á especificar en su propuesta la marca y producto ofrecido, ficha técnica o características principales, sistema de aplicación, canti»
