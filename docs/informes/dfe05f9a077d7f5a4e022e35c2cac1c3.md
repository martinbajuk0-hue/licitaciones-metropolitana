...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1354405
...
- **Terminología genérica del pliego (revisar manualmente qué producto aplica)** ("recubrimiento"): ...ión  Cantidad  (Hasta) Observaciones  1 71495  CERAMICA DE  RECUBRIMIENTO  DENTAL  TIPO ----- GRAMOS 10    2 71495  CERAMICA DE  RECU...
- **Material mencionado (revisar contexto)** ("ceramica"): ...de  Presentación  Cantidad  (Hasta) Observaciones  1 71495  CERAMICA DE  RECUBRIMIENTO  DENTAL  TIPO ----- GRAMOS 10    2 71495...
- **Material mencionado (revisar contexto)** ("cerámica"): ...1 | 13    CONCURSO DE PRECIOS Nº 05/2026  “ADQUISICIÓN DE CERÁMICA DENTAL Y CAD-CAM”    RESUMEN:   RECEPCIÓN DE OFERTAS:  Se d...
...
- Lugar de uso mencionado: almacen, correo, facultad, recepción, udelar, universidad

## Riesgos detectados
Altos: 1 · Medios: 1 · Total: 2

- [ALTA] multas_penalidades: Riesgo de rescisión contractual — «, ésta podrá  desestimar la compra por este motivo.    12.  RESCISIÓN DEL CONTRATO:  La Facultad de Odontología podrá rescindir unilateralment»
...
- Formulario de identificación del oferente — evidencia: «3 DATOS DEL OFERENTE:   Se deberá adjuntar el Formulario de Identificación del Oferente con la firma del  representante declarado en RUPE (Ver Anex»
