# Informe de licitación: Concurso de Precios 77/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1349437
...
- **Material mencionado (revisar contexto)** ("cedro"): ...NDO      Descripción      Se confeccionarán de madera dura (cedro nogal o similar) y se conformará  de empuñadura, cuerpo pro...
- **Material mencionado (revisar contexto)** ("madera"): ...ASTÓN DE COMANDO      Descripción      Se confeccionarán de madera dura (cedro nogal o similar) y se conformará  de empuñadura...
...
- [ALTA] multas_penalidades: Mora automática — «ARTÍCULO 23: MORA Y SANCIONES El adjudicatario incurrirá en mora de pleno derecho sin necesidad de interpelación judicial o extrajudicial alg»
- [ALTA] multas_penalidades: Penalidades mencionadas — «nsiguiente pérdida de la garantía constituida. ARTICULO 24: PENALIDADES Sin  perjuicio  de  lo  dispuesto  en  los  artículos  ante»
...
- Pólizas de seguro (responsabilidad civil / accidentes) — evidencia: «rior. Concurso de Precios número 77/2026. Tipo de documento Póliza de Seguro de Fianza emitida por una empresa aseguradora ins»
- Formulario de identificación del oferente — evidencia: «, en su defecto, documentación con todos los Formulario de  Identificación  del Oferente y  Declaración. datos requeridos en el modelo adjunto, el c»
