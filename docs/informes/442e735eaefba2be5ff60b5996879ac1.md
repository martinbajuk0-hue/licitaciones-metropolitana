# Informe de licitación: Compra Directa 20095/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1354515
...
Categorías de producto detectadas: Marca de mercado mencionada, Normativa/certificación mencionada.
...
Categorías detectadas: Marca de mercado mencionada, Normativa/certificación mencionada

- **Normativa/certificación mencionada** ("abnt"): ...ulo Ecológico para Impressoras e Equipamentos de Imagem” de ABNT, que  incluya el período de validez de éste;   ▪ Especifica...
- **Normativa/certificación mencionada** ("declaración de conformidad"): ...n respecto a  la restricción de sustancias peligrosas);   ▪ Declaración de conformidad CE del fabricante o su representante autorizado.  Garantía,...
- **Marca de mercado mencionada** ("interface"): ...022, 2025   Apple Macintosh: macOS 11.7.10~macOS 14.15      Interfaces estándar:   Puerto USB A: N/A   Puerto USB B: Hi-Speed USB...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: fabrica, puerto
- Aplicación mencionada: certificado, ecológico
