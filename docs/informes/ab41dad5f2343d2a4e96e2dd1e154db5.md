# Informe de licitación: Compra Directa 1512/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1369549
**Generado:** 2026-09-07 15:37
**Qué es:** Licitación de ASSE - Administración de los Servicios de Salud del Estado — busca Alfombras, Variante/error ortográfico de un término del rubro. Menciona "carpet": «e: ITEM CODIGO -SICE CONCEPTO/ARTICULO CANT. 1 25320 CARPETA DE CARTULINA - CARPETA VERDE CONTRATAPA CON SOLAPAS EN LA»
...
- **Alfombras** ("carpet"): ...e:    ITEM CODIGO  -SICE CONCEPTO/ARTICULO CANT.  1  25320  CARPETA DE CARTULINA - CARPETA VERDE CONTRATAPA CON SOLAPAS  EN LA...
- **Variante/error ortográfico de un término del rubro** ("carpeta"): ...e:    ITEM CODIGO  -SICE CONCEPTO/ARTICULO CANT.  1  25320  CARPETA DE CARTULINA - CARPETA VERDE CONTRATAPA CON SOLAPAS  EN LA...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: almacen, asse, correo, hospital, oficina, recepción

## Riesgos detectados
Altos: 0 · Medios: 1 · Total: 1

- [MEDIA] plazos: Plazo de 48 horas mencionado — «s y Licitaciones: Ana Rodríguez - Int 1140   Entrega hasta 48 horas de recibida la Orden de Compra.   Se solicita catálogos de»

## Checklist documental
### Exigidos explícitamente en el pliego
- Catálogos de producto — evidencia: «sta 48 horas de recibida la Orden de Compra.   Se solicita catálogos de los ítems ofertados   Se solicita pasar a retirar mues»
