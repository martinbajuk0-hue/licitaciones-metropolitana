# Informe de licitación: Compra Directa 324/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1361500
...
- **Alfombras** ("carpet"): ...ón de un correo específico, un archivo  adjunto individual, carpetas particulares o un buzón completo en su estado  original o...
- **Variante/error ortográfico de un término del rubro** ("carpeta"): ...ón de un correo específico, un archivo  adjunto individual, carpetas particulares o un buzón completo en su estado  original o...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: correo, dirección, miem
