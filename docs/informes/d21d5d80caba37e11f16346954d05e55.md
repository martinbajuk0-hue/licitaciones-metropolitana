# Informe de licitación: Licitación Abreviada 109305/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1363133
...
- **Material mencionado (revisar contexto)** ("fibra de vidrio"): ...cánica.  Son estructuras ligeras de poliéster reforzado con fibra de vidrio y forma troncocónica, diseñadas  con alta resistencia mecán...
...
- **Material mencionado (revisar contexto)** ("madera"): ...los postes quedan definidas por la norma C4C02 -  POSTES DE MADERA TRATADOS.              En las colocaciones de postes ya sea...
...
- Lugar de uso mencionado: almacen, antel, banco, bps, correo, depósito, depósitos, direccion, dirección, galería, galerías, instituto, intendencia, ma, mi
- Aplicación mencionada: certificado, exterior, interior, reciclable

## Riesgos detectados
Altos: 0 · Medios: 3 · Total: 3

- [MEDIA] plazos: Plazo de 48 horas mencionado — «o  de investigación correspondiente, en un plazo máxim o de 48 horas.   10) En caso de emplear subcontratistas exigiremos f ehac»
...
- Certificado único de BPS vigente — evidencia: «o por la Ley 14.411, Antel s e hace cargo de los aportes al BPS. La  Administración mensualmente emitirá una factura por  d»
- Poderes / representación legal vigentes — evidencia: «(artículo  239 del Código Penal).      Firma del apoderado/representante legal:   Aclaración:               Timbre               (*) Antel»
- Declaraciones juradas exigidas — evidencia: «e la contratación.                    Página 24     ANEXO 2 DECLARACIÓN JURADA  SEGURIDAD, HIGIENE Y SALUD EN EL TRABAJO (EN CASO D E ADJU»
