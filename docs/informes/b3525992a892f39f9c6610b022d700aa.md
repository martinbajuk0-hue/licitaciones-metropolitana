...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1368663
**Generado:** 2026-09-03 23:21
**Qué es:** Licitación de Ministerio de Desarrollo Social (MIDES) — busca Material mencionado (revisar contexto). Menciona "algodón": «mpermeable para evitar fugas. ● Con inserto absorbente de algodón en color blanco o crudo 1000 Forma de entrega: Cada»
...
- **Material mencionado (revisar contexto)** ("algodón"): ...mpermeable para evitar  fugas.  ● Con inserto absorbente de algodón en color blanco o crudo    1000    Forma de entrega:  Cada...
- **Material mencionado (revisar contexto)** ("nylon"): ...crudo    1000    Forma de entrega:  Cada pañal en bolsa de nylon     Modo de entrega: deben entregarse en cajas cerradas deb...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: depósito, dirección, mides, ministerio, oficina, tribunal
- Aplicación mencionada: exterior, impermeable, lavable
