# Informe de licitación: Compra Directa 3354/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1372981
**Generado:** 2026-09-18 14:17
**Qué es:** Licitación de ASSE - Administración de los Servicios de Salud del Estado — busca Material mencionado (revisar contexto). Menciona "algodón": «em N°1: 200 sabanas Detallo características : tela crea 50% algodón y 50 % poliéster, color blanco con logo en azul institucio»
...
- **Material mencionado (revisar contexto)** ("algodón"): ...em N°1: 200 sabanas Detallo características : tela crea 50% algodón y 50 % poliéster,  color blanco con logo en azul institucio...
- **Material mencionado (revisar contexto)** ("poliéster"): ...anas Detallo características : tela crea 50% algodón y 50 % poliéster,  color blanco con logo en azul institucional, de 1.60 x 2....
...
- Muestras físicas de producto — evidencia: «.60 x 2.65 mt con dobladillo de 1cm aproximado. Se solicita muestra física para corroborar lo solicitado. Forma de cotizar: Se deberá»
