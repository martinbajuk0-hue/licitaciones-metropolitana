# Informe de licitación: Compra Directa 1011/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1370258
**Generado:** 2026-09-09 14:14
**Qué es:** Licitación de organismo no identificado — busca Material mencionado (revisar contexto). Menciona "caucho": «ara el autoclave con temperaturas de 121 grados deben tener caucho - se solicita muestras enviarla a sector Intendencia Hospit»
...
- **Material mencionado (revisar contexto)** ("caucho"): ...ara el autoclave con temperaturas de 121 grados deben tener caucho - se solicita muestras enviarla a sector Intendencia Hospit...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: hospital, hospital regional, intendencia
