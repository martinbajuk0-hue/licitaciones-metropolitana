# Informe de licitación: Compra Directa 63/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1353728
**Generado:** 2026-09-04 18:15
**Qué es:** Licitación de OSE - Obras Sanitarias del Estado — busca Abreviatura técnica del rubro, Material mencionado (revisar contexto), Pisos vinílicos. Menciona "pvc": «logada marcado CE: Antienganche de color negro realizada en PVC Alzado Transversal Escala 1/20 PREMARCO: De acero inoxidabl»
...
- **Pisos vinílicos** ("pvc"): ...logada marcado CE: Antienganche de color negro realizada en PVC Alzado Transversal Escala 1/20 PREMARCO: De acero inoxidabl...
- **Material mencionado (revisar contexto)** ("acero galvanizado"): ...cia de e=1,2mm (mínimo) De 53mm de espesor de construida en acero galvanizado de 0,7mm (mínimo) tipo skinpass rellena de poliestireno exp...
- **Material mencionado (revisar contexto)** ("acero inoxidable"): ...ante existente, y la caja de piso. Se colocará una tapa en  acero inoxidable en el lugar de la caja de piso.   2.1.2. Se deberá retirar...
- **Material mencionado (revisar contexto)** ("aluminio"): ...ma de ventanas  Se repararán y/o reformarán dos ventanas de aluminio de acuerdo a planillas adjuntas (AL01 y  AL02).       3. FO...
- **Material mencionado (revisar contexto)** ("poliestireno"): ...cero galvanizado de 0,7mm (mínimo) tipo skinpass rellena de poliestireno expandido o nido de abeja. Acabado de marco y hoja, pintura...
- **Material mencionado (revisar contexto)** ("pvc"): ...logada marcado CE: Antienganche de color negro realizada en PVC Alzado Transversal Escala 1/20 PREMARCO: De acero inoxidabl...
- **Abreviatura técnica del rubro** ("pvc"): ...logada marcado CE: Antienganche de color negro realizada en PVC Alzado Transversal Escala 1/20 PREMARCO: De acero inoxidabl...
...
- [ALTA] multas_penalidades: Mora automática — «nismo.    17. MORA Y PENALIDADES  El adjudicatario caerá en mora de pleno derecho y sin necesidad de pro testo, ni de  interpelación judicial»
- [ALTA] multas_penalidades: Penalidades mencionadas — «os  bienes recibidos por parte del Organismo.    17. MORA Y PENALIDADES  El adjudicatario caerá en mora de pleno derecho y sin nece»

## Checklist documental
### Exigidos explícitamente en el pliego
- Inscripción activa en RUPE — evidencia: «ravés de correo electrónico  indicado por el proveedor o en RUPE.    5.   COTIZACION DE LA PROPUESTA  Se deberá cotizar excl»
...
- Constancia de visita de obra (si el pliego la exige) — evidencia: «s y complementarias.     3.  VISITAS     No obligatoria. La visita previa cotización de los trabajos solicitados no es obligatoria, a»
- Formulario de identificación del oferente — evidencia: «ente documentación, debidamente firmada:     Formulario de identificación del oferente. (Anexo I)   Formulario de Oferta Económica    Formulario»
