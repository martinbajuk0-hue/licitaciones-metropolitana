# Informe de licitación: Compra Directa 153826/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1370808
**Generado:** 2026-09-10 18:19
**Qué es:** Licitación de UTE - Administración Nacional de Usinas y Trasmisiones Eléctricas — busca Abreviatura técnica del rubro, Accesorios de instalación, Marca de mercado mencionada, Material mencionado (revisar contexto), Pisos de madera, Pisos flotantes/laminados, Pisos vinílicos, Terminología genérica del pliego (revisar manualmente qué producto aplica), Variante/error ortográfico de un término del rubro. Menciona "pvc": «to en baño/cocina desde aparatos o mesada hasta columna en PVC de acuerdo a reglamentación municipal vigente y manuales d»
...
## Datos clave
- Organismo: UTE - Administración Nacional de Usinas y Trasmisiones Eléctricas
- Número de licitación/expediente: 81.321
...
- **Pisos vinílicos** ("pvc"): ...to en baño/cocina desde aparatos o mesada hasta columna  en PVC  de acuerdo a reglamentación municipal vigente y manuales d...
...
- **Pisos de madera** ("parquet"): ...locar deberán ser de igual terminación a las existentes.    Parquet: Se realizará la reposición y pegado de tablillas de parque...
...
- **Accesorios de instalación** ("zócalo"): ...tal de pisos de parquet, previamente  se deberá retirar los zócalos existentes, no admitiéndose diferencias de nivel ni sobres...
- **Accesorios de instalación** ("zócalos"): ...tal de pisos de parquet, previamente  se deberá retirar los zócalos existentes, no admitiéndose diferencias de nivel ni sobresa...
- **Terminología genérica del pliego (revisar manualmente qué producto aplica)** ("baldosa"): ...tener piezas enteras. En sustitución parcial  de pisos, las baldosas a colocar deberán ser de igual terminación a las existente...
...
- **Material mencionado (revisar contexto)** ("acero inoxidable"): ...riante a elección de la  dirección de la obra con pileta de acero inoxidable completa.    2) INSTALACION SANITARIA    2.1) Abastecimient...
- **Material mencionado (revisar contexto)** ("aluminio"): ...Sika Flex o similar.   4.1.1) Sustitución por aberturas de aluminio (sustitución, suministro y colocación):  Se realizará por a...
...
- **Material mencionado (revisar contexto)** ("granito"): ...alación.  Mesada:   De ser necesario, se colocará mesada de granito, mármol u otra variante a elección de la  dirección de la o...
...
- **Material mencionado (revisar contexto)** ("madera"): ...á malla de protección que deberá ser realizada con marco de madera y malla  plástica tipo mosquitero de color negro.     7) LI...
...
- **Material mencionado (revisar contexto)** ("pvc"): ...to en baño/cocina desde aparatos o mesada hasta columna  en PVC  de acuerdo a reglamentación municipal vigente y manuales d...
...
- **Abreviatura técnica del rubro** ("pvc"): ...to en baño/cocina desde aparatos o mesada hasta columna  en PVC  de acuerdo a reglamentación municipal vigente y manuales d...
...
- Lugar de uso mencionado: banco, bps, bse, comedor, depósito, dirección, fabrica, facultad, garaje, mtss, ose, parque, patio, recepcion, recepción
