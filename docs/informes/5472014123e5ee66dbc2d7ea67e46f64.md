...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1358991
**Generado:** 2026-08-25 12:29
**Qué es:** Licitación de Intendencia de Soriano — categorías de producto detectadas: Terminología genérica del pliego (revisar manualmente qué producto aplica).
...
- **Terminología genérica del pliego (revisar manualmente qué producto aplica)** ("memoria constructiva"): ...de Deportes de Cardona. (en anexo II, III y IV se adjuntan memoria constructiva descriptiva y planos respectivamente)...
- **Terminología genérica del pliego (revisar manualmente qué producto aplica)** ("plaza de deportes"): ...a a CONCURSO DE PRECIOS para mano de obra de albañilería en Plaza de Deportes de Cardona. (en anexo II, III y IV se adjuntan memoria cons...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: intendencia, intendencia de soriano, plaza
