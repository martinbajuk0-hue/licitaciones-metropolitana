# Informe de licitación: Compra Directa 10221/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1372859
**Generado:** 2026-09-17 18:55
**Qué es:** Licitación de UDELAR - Universidad de la República — busca Contenedores habitables, garitas y módulos. Menciona "baños químicos": «solicita cotización para el servicio de alquiler de cuatro baños químicos para actividad a desarrollarse en el en UDELAR del departam»
...
Organismo: UDELAR - Universidad de la República.
Número: no identificado — verificar manualmente.
Fecha de apertura: no identificada — verificar manualmente.
Categorías de producto detectadas: Contenedores habitables, garitas y módulos.
...
Categorías detectadas: Contenedores habitables, garitas y módulos

- **Contenedores habitables, garitas y módulos** ("baños químicos"): ...solicita cotización para el servicio de alquiler de cuatro baños químicos para actividad a desarrollarse en el en UDELAR del departam...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: udelar
