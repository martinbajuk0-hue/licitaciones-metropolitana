...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1367791
**Generado:** 2026-09-01 23:17
**Qué es:** Licitación de Intendencia de Florida — busca Material mencionado (revisar contexto). Menciona "acero al carbono": «a la normativa vigente.  Tanque barométrico construido en acero al carbono de alta resistencia.  Capacidad útil del tanque no inferio»
...
- **Material mencionado (revisar contexto)** ("acero al carbono"): ...a la normativa vigente.  Tanque barométrico construido en acero al carbono de alta resistencia.  Capacidad útil del tanque no inferio...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: banco, depósito, dirección, fabrica, fábrica, intendencia, intendencia de florida, juzgado, mef, recepción, tribunal
- Aplicación mencionada: certificado

## Riesgos detectados
Altos: 1 · Medios: 0 · Total: 1

- [ALTA] multas_penalidades: Mora automática — «no cumplir con lo pactado dará lugar a que se configure la mora de pleno derecho, sin necesidad  de  interpelación  de  clase  alguna,  excl»

## Checklist documental
### Exigidos explícitamente en el pliego
- Inscripción activa en RUPE — evidencia: «te  en  el  Registro  Único  de  Proveedores  del  Estado  (RUPE),  la  comunicación  de publicación del acta. Será de respo»
- Garantía de fiel cumplimiento de contrato — evidencia: «F de corresponder el adjudicatario  deberá  depositar como  garantía  de  fiel cumplimiento  del  contrato,  en  la División Tesorería de la Intendenci»
- Pólizas de seguro (responsabilidad civil / accidentes) — evidencia: «ar acompañada de certificación notarial de las firmas;  b)  Póliza  de  seguro  de  fianza.  En  caso  de  Institución  Bancar»
