# Informe de licitación: Compra Directa 1047/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1355796
**Generado:** 2026-08-25 03:01
**Qué es:** Licitación de organismo no identificado — categorías de producto detectadas: Marca de mercado mencionada, Material mencionado (revisar contexto).
...
- **Material mencionado (revisar contexto)** ("acero inoxidable"): ...ITUD: 40 bitas de hierro galvanizado 50 varillas roscada de acero inoxidable de 20mm 250 arandelas de acero inoxidable para (varilla de...
- **Marca de mercado mencionada** ("sika"): ...0mm 15 tubos de anclaje químico similar a (adhesivo químico Sika Anchorfix-2 300ml) (SE ADJUNTA PLANO CON MEDIDAS DE LA BITA...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: dirección, ministerio, puerto
...
- Inscripción activa en RUPE — evidencia: «r crédito, a través del SIIF deberán estar inscriptas en el RUPE. PLANTA NOTAS: Planchuela de e-1/2"	EL MATERIAL DE LAS BITA»
