...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1372966
**Generado:** 2026-09-17 23:24
**Qué es:** Licitación de Intendencia de Florida — busca Material mencionado (revisar contexto), Pisos vinílicos. Menciona "vinilo": «ow Bold, caja minúscula de 5 cm de alto, aplicada mediante vinilo reflectivo autoadhesivo color blanco marca 3M o equivalent»
...
- **Material mencionado (revisar contexto)** ("poliéster"): ...ONES TECNICAS  a) Paleta (panel nomenclatura)    Material: Poliéster Reforzado con Fibra de Vidrio (PRFV) termo prensado,  con b...
