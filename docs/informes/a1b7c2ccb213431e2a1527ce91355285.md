# Informe de licitación: Compra Directa 179/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1357183
**Generado:** 2026-08-25 02:14
**Qué es:** Licitación de Ministerio de Transporte y Obras Públicas (MTOP) — categorías de producto detectadas: Abreviatura técnica del rubro, Material mencionado (revisar contexto), Pisos vinílicos.
...
- **Pisos vinílicos** ("pvc"): ...ripción 1 | 1 unidad | Manguera verde flexible corrugada de PVC reforzada para riego y conducción de agua de 3 pulgadas y 1...
- **Material mencionado (revisar contexto)** ("epoxi"): ...ón de agua de 3 pulgadas, con un largo de 12 mts. y Pintura Epoxi”, por la cantidad o hasta la suma de $ 654.000 (seiscientos...
- **Material mencionado (revisar contexto)** ("pvc"): ...ripción 1 | 1 unidad | Manguera verde flexible corrugada de PVC reforzada para riego y conducción de agua de 3 pulgadas y 1...
- **Abreviatura técnica del rubro** ("pvc"): ...ripción 1 | 1 unidad | Manguera verde flexible corrugada de PVC reforzada para riego y conducción de agua de 3 pulgadas y 1...
...
- Lugar de uso mencionado: dirección, fabrica, ministerio, mtop, plaza, recepción
- Aplicación mencionada: certificado, exterior, interior

## Riesgos detectados
Altos: 0 · Medios: 1 · Total: 1

- [MEDIA] certificaciones: Certificación ISO exigida — «esistencia a corrosión atmosférica (ambientes C3 a C5 según ISO 12944). Resistencia a humedad permanente y condensación. Resisten»
