...
- **Material mencionado (revisar contexto)** ("goma"): ...10lts)   Item   7     hasta     50   pares   Guantes   de   goma   talle   M     Item     8     hasta     25   pares   Guant...
- **Material mencionado (revisar contexto)** ("látex"): ...Item   10     hasta       10   pares   de   guantes   de   látex   talle   L   (caja   x100)   Item     11     hasta     20...
- **Material mencionado (revisar contexto)** ("madera"): ...Item   4     hasta     170   litros   de   cera   para   madera   sin   solventes   color   roble   oscuro   (presentación...
- **Material mencionado (revisar contexto)** ("nylon"): ...)   Item   19     hasta     600   kg   de   Bolsas   de   NYLON   de   1mt   x   70   cm   color   negro   Item   20     ha...
- **Material mencionado (revisar contexto)** ("roble"): ...ros   de   cera   para   madera   sin   solventes   color   roble   oscuro   (presentación   900ml)   Item   5     hasta...
