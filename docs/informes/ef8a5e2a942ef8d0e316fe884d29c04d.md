...
**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1368924
**Generado:** 2026-09-03 23:18
**Qué es:** Licitación de organismo no identificado — busca Terminología genérica del pliego (revisar manualmente qué producto aplica). Menciona "reforma de local": «Licitación Abreviada 2/2026 REFORMA DE LOCALES EN EDIFICIO DE SALA DE ANATOMÍA EN HOSPITAL - PAYSANDU»
...
## Datos clave
- Organismo: **NO IDENTIFICADO — verificar manualmente**
- Número de licitación/expediente: 2/2026
...
- **Terminología genérica del pliego (revisar manualmente qué producto aplica)** ("reforma de local"): ...Licitación Abreviada 2/2026 REFORMA DE LOCALES EN EDIFICIO DE SALA DE ANATOMÍA EN HOSPITAL - PAYSANDU...

### Contexto adicional (lugar de uso / aplicación)
- Lugar de uso mencionado: hospital
