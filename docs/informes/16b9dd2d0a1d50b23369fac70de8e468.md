# Informe de licitación: Compra Directa 16454/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1374953
**Generado:** 2026-09-25 15:04
**Qué es:** Licitación de OSE - Obras Sanitarias del Estado — busca Abreviatura técnica del rubro, Material mencionado (revisar contexto), Pisos vinílicos, apertura 2026-09-29. Menciona "pvc": «PIEL / (VARIANTE: -----) UNIDAD 60 unidades 12 MANGUERA DE PVC / (VARIANTE: DIÁMETRO EXTERNO X DIÁMETRO INTERNO 3/8 X 1/»
...
- Fecha de apertura: 2026-09-29 (Cierra en 4 días)
...
- **Pisos vinílicos** ("pvc"): ...PIEL /  (VARIANTE: -----) UNIDAD 60 unidades 12 MANGUERA DE PVC / (VARIANTE:  DIÁMETRO EXTERNO X DIÁMETRO  INTERNO 3/8 X 1/...
- **Material mencionado (revisar contexto)** ("algodón"): ...ox 250 metros (en rollos de 50 mts  aprox) 13 MALLA TUBULAR ALGODÓN USO TÓRAX /  (VARIANTE: -----) M *rollos de 25 mts. Aprox....
- **Material mencionado (revisar contexto)** ("polipropileno"): ...NA / (VARIANTE:  TAMAÑO 30 X 30) UNIDAD 2 unidades 15 MALLA POLIPROPILENO / (VARIANTE:  TAMAÑO 30 X 30) UNIDAD 2 unidades 16 GASA IOD...
- **Material mencionado (revisar contexto)** ("pvc"): ...PIEL /  (VARIANTE: -----) UNIDAD 60 unidades 12 MANGUERA DE PVC / (VARIANTE:  DIÁMETRO EXTERNO X DIÁMETRO  INTERNO 3/8 X 1/...
- **Abreviatura técnica del rubro** ("pvc"): ...PIEL /  (VARIANTE: -----) UNIDAD 60 unidades 12 MANGUERA DE PVC / (VARIANTE:  DIÁMETRO EXTERNO X DIÁMETRO  INTERNO 3/8 X 1/...
...
- Catálogos de producto — evidencia: «Ítem Detalle Cantidad  Hasta ADJUNTAR  (prioritariamente)  CATALOGO  CON   CARACTERISTICAS TECNICAS PARA ITEMS: 4, 11,   12, 13»
