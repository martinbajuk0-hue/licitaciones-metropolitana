# Informe de licitación: Compra Directa 229/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1360194
...
- +25 por código de artículo ARCE ya adjudicado a Metropolitana antes (match exacto, no por texto): CESPED SINTETICO
...
Categorías de producto detectadas: Césped sintético, Variante/error ortográfico de un término del rubro.
...
Categorías detectadas: Césped sintético, Variante/error ortográfico de un término del rubro

- **Césped sintético** ("cesped sintetico"): ...Compra Directa 229/2026 ADQUISICIÓN DE CESPED SINTETICO PARA LA D.N.B. PARA COMPETENCIA DEPORTIVA...
- **Variante/error ortográfico de un término del rubro** ("cesped"): ...Compra Directa 229/2026 ADQUISICIÓN DE CESPED SINTETICO PARA LA D.N.B. PARA COMPETENCIA DEPORTIVA...
- **Variante/error ortográfico de un término del rubro** ("esped sintetico"): ...Compra Directa 229/2026 ADQUISICIÓN DE CESPED SINTETICO PARA LA D.N.B. PARA COMPETENCIA DEPORTIVA...

### Ya adjudicaste antes
Metropolitana ya le vendió al Estado alguno de estos productos antes (historial 2025-2026, ver knowledge/historial_adjudicaciones_metropolitana.json): CESPED SINTETICO, COLOCACION DE PANES DE CESPED.
## Riesgos detectados
