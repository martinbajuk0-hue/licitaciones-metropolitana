# Informe de licitación: Compra Directa 88640/2026

**URL:** https://www.comprasestatales.gub.uy/consultas/detalle/id/1361365
...
- **Material mencionado (revisar contexto)** ("epoxi"): ...produzcan deformaciones y pintado con dos capas de esmalte epoxi color gris  grafito o material similar que permita la resis...
- **Material mencionado (revisar contexto)** ("goma"): ...io de 10 mm de diámetro mínimo, el cual tendrá  un tapón de goma ubicado desde el interior del gabinete. Este será utilizado...
- **Material mencionado (revisar contexto)** ("nylon"): ...e triángulo para cierre de tableros eléctricos  (metálico y nylon)  Nylon  negro  6036.0005.52 Cierre Nylon para tableros elé...
- **Material mencionado (revisar contexto)** ("polipropileno"): ...cnica de San José      4      TUBERÍA    La tubería será de Polipropileno Copolímero Random (tipo 3) de 20 mm PN 10 unida  mediante t...
...
- Lugar de uso mencionado: correo, dirección, estación de servicio, fabrica, facultad, oficina, oficinas, ose, recepción
